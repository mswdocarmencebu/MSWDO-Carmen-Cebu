...
import { ApplicantUserHeader } from "./ApplicantUserHeader"
import { ApplicantUserSidebar } from "./ApplicantUserSidebar"

export function ApplicantUserLayout({ children, activeTab = "applications", onTabChange }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-foreground flex flex-col lg:flex-row antialiased">
      ...
      {/* Applicant User Dedicated Sidebar */}
      <ApplicantUserSidebar
